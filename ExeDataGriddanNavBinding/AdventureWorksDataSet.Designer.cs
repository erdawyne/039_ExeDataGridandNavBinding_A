...
namespace ExeDataGriddanNavBinding {
    ...
    public partial class AdventureWorksDataSet : global::System.Data.DataSet {
        ...
        public partial class ContactDataTable : global::System.Data.TypedTableBase<ContactRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ContactRow AddContactRow(bool NameStyle) {
...
namespace ExeDataGriddanNavBinding.AdventureWorksDataSetTableAdapters {
    ...
    public partial class ContactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Person].[Contact] WHERE (([ContactID] = @Original_ContactID) AND ([N" +
                "ameStyle] = @Original_NameStyle))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Person].[Contact] SET [NameStyle] = @NameStyle WHERE (([ContactID] = @Ori" +
                "ginal_ContactID) AND ([NameStyle] = @Original_NameStyle));\r\nSELECT ContactID, Na" +
                "meStyle FROM Person.Contact WHERE (ContactID = @ContactID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ExeDataGriddanNavBinding.Properties.Settings.Default.AdventureWorksConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactID, NameStyle FROM Person.Contact";
        ...
        public virtual int Delete(int Original_ContactID, bool Original_NameStyle) {
        ...
        public virtual int Update(bool NameStyle, int Original_ContactID, bool Original_NameStyle, int ContactID) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((bool)(Original_NameStyle));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(ContactID));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(bool NameStyle, int Original_ContactID, bool Original_NameStyle) {
            return this.Update(NameStyle, Original_ContactID, Original_NameStyle, Original_ContactID);
        }
    }
